...
# Number of requests without threads
requests_without_threads = 100
...
# Without threads
def make_requests_without_threads():
    for _ in range(requests_without_threads):
...
# # # # Without threads
make_requests_without_threads()

# # # # With threads
# def make_requests_with_threads(thread_num):
...
#     thread = threading.Thread(target=make_requests_with_threads, args=(i,))
